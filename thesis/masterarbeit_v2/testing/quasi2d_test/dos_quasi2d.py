...
def calculate_ldos_parallel(alpha_raw, beta_raw, energy_array=None, n_jobs=-1):
    ...
    Hs, Hb, Hn, V0, Vd = _build_hamiltonians(alpha_raw, beta_raw, B_field=0.0)
...
# =============================================================================
#%% Majorana probability density via full diagonalization
# =============================================================================
...
def plot_majorana_density(rho, E_min, phi, B_field, NS=20):
    ...
    cf = ax.contourf(np.arange(Ntot), np.arange(ny), rho.T,
                     levels=100, cmap='hot')
...
if __name__ == '__main__':
    ...
    ldos_E_phi = calculate_ldos_parallel(alpha_1, beta_1)
    ...
    ldos_xy = calculate_ldos_spatial(alpha_1, beta_1, phi=np.pi, target_energy=0.0)
    ...
    rho, E_min = majorana_density(alpha_1, beta_1, B_field=0.5, phi=np.pi, NS=20)
    plot_majorana_density(rho, E_min, phi=np.pi, B_field=0.5, NS=20)
