...
def Iterator_retarded(energy:float, eps:np.ndarray(4), t_matrix:np.ndarray(4)) -> np.ndarray(4,dtype=complex): # type: ignore
    '''
...
def Iterator_advanced(energy:float, eps:np.ndarray(4), t_matrix:np.ndarray(4)) -> np.ndarray(4,dtype=complex): # type: ignore
    '''
